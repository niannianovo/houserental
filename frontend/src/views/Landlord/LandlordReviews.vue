            ...
            <div v-loading="loading">
                <div v-for="r in reviews" :key="r.id" class="review-item">
                    <div class="review-header">
                        ...
                        <el-rate v-model="r.rating" disabled :size="'small'" style="margin-left: 8px;" />
...
.review-item { padding: 16px 0; border-bottom: 1px solid #e8f0f8; }
.review-item:last-child { border-bottom: none; }
.review-header { display: flex; align-items: center; gap: 8px; margin-bottom: 8px; }
.review-user { font-size: 14px; font-weight: 500; color: #1a3a5c; }
.review-role { font-size: 12px; color: #7a94a8; margin-left: 4px; }
...
:deep(.el-radio-button__inner) { border-color: #c8d8e8 !important; }
:deep(.el-radio-button__original-radio:checked + .el-radio-button__inner) { background: #5b9bd5 !important; border-color: #5b9bd5 !important; }
