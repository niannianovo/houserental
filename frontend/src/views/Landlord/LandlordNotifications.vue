<template>
    <div>
        <el-card class="blue-card">
            ...
            <el-tabs v-model="activeTab" class="blue-tabs">
            ...
            <div v-if="activeTab === 'notify'" v-loading="loading">
                <div v-if="notifications.length === 0" style="text-align: center; padding: 40px; color: #7a94a8;">暂无消息</div>
                <div
            ...
            <div v-if="activeTab === 'announcement'" v-loading="loadingAnn">
                <div v-if="announcements.length === 0" style="text-align: center; padding: 40px; color: #7a94a8;">暂无公告</div>
                <div
...
.more-btn { color: #5b9bd5 !important; }
.more-btn:hover { color: #1a3a5c !important; }
.blue-tabs :deep(.el-tabs__active-bar) { background: #5b9bd5; }
.blue-tabs :deep(.el-tabs__item.is-active) { color: #1a3a5c; }
...
.notify-item:hover, .announce-item:hover { background: #f3f7fb; }
.notify-item.unread { background: #e8f0f8; }
...
.notify-title { font-size: 15px; font-weight: 500; color: #1a3a5c; margin-bottom: 4px; }
.notify-content { font-size: 13px; color: #7a94a8; line-height: 1.5; }
